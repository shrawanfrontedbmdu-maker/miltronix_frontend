...
import { createServiceRequestApi } from "../../api/api"; // adjust path as needed
...
const steps = [
  {
    ...
    icon: "📋",
    title: "Fill the Form",
    desc: "Enter your product details, order ID, and describe the issue clearly.",
  },
  {
    number: "02",
    icon: "✅",
    title: "Verification",
    desc: "Our team verifies your warranty status within 24 business hours.",
  },
  {
    number: "03",
    icon: "🔧",
    title: "Repair / Replace",
    desc: "We schedule pickup or direct you to the nearest service centre.",
  },
  {
    number: "04",
    icon: "📦",
    title: "Return Delivery",
    desc: "Repaired or replaced product delivered back to your doorstep.",
  },
];
...
const s = {
  ...
  stepCard: {
    ...
    borderRadius: "18px",
    padding: "36px 28px",
    border: "1px solid rgba(97,109,107,0.13)",
    height: "100%",
    position: "relative",
    overflow: "hidden",
  ...
  formInput: {
    width: "100%",
    border: "none",
    borderBottom: "1.5px solid rgba(97,109,107,0.25)",
  ...
  formTextarea: {
    width: "100%",
    border: "1.5px solid rgba(97,109,107,0.25)",
    background: "transparent",
    padding: "14px 16px",
    fontSize: "14px",
    color: C.text,
...
function ClaimForm() {
  ...
  const [claimId] = useState(
    "WC-" + Math.floor(Math.random() * 900000 + 100000),
  );
  ...
  const submit = async () => {
    ...
    try {
      await createServiceRequestApi({
        ...
        description: `Issue Type: ${form.issueType}. ${form.description.trim()}`,
    ...
    return (
      <div style={{ textAlign: "center", padding: "50px 20px" }}>
        ...
        <p style={{ color: C.muted, fontSize: "15px", marginBottom: "16px" }}>
          Your warranty claim has been registered. Our team will contact you
          within 24 hours.
        </p>
        <div
          style={{
    ...
    <div style={s.formCard}>
      <div className="row g-3">
        ...
        <div className="col-12">
          <div style={s.sectionDivider}>📦 Product Details</div>
        </div>
        ...
        <div className="col-md-6">
          <label style={s.formLabel}>Preferred Service Date</label>
          <input
            name="preferredDate"
            type="date"
        ...
        {/* ── ADDRESS ── */}
        <div className="col-12">
          <div style={s.sectionDivider}>🏠 Pickup Address</div>
        </div>
        ...
        {/* ── PAYMENT ── */}
        <div className="col-12">
          <div style={s.sectionDivider}>💳 Payment Details</div>
        </div>
        ...
        <div className="col-md-6">
          <label style={s.formLabel}>Service Amount (₹)</label>
          <input
            name="paymentAmount"
        ...
        <div className="col-12">
          ...
          >
            ...
            <div>
              <div
                style={{ fontSize: "13px", fontWeight: "600", color: C.dark }}
              >
                Attach Photos / Invoice (optional)
              </div>
              <div style={{ fontSize: "12px", color: C.muted }}>
                Upload images of the defect and your purchase invoice for faster
                processing.
              </div>
            </div>
          </div>
        ...
        <div className="col-12" style={{ marginTop: "8px" }}>
          ...
          <p style={{ fontSize: "12px", color: C.muted, marginTop: "12px" }}>
            * Fields marked are required. Our team will verify your claim and
        ...
        <div>
          ...
          >
            <div style={{ fontSize: "13px", color: C.muted }}>
              Claim ID: <strong style={{ color: C.dark }}>{result.id}</strong>
            </div>
            <div
              style={{
                fontSize: "12px",
              ...
              <React.Fragment key={step}>
                <div
                  style={{
                    ...
                    alignItems: "center",
                    flex: i < statusSteps.length - 1 ? "none" : 1,
                  }}
                >
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        i <= result.step ? C.primary : "rgba(97,109,107,0.15)",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: "13px",
                  ...
                  <div
                    style={{
                      fontSize: "10px",
                      color: i <= result.step ? C.primary : C.muted,
                      marginTop: "6px",
                      textAlign: "center",
                      fontWeight: "600",
                      whiteSpace: "nowrap",
      ...
      <main className="main-content-padding">
        ...
        <section style={{ backgroundColor: "#bebfbe", padding: "20px 0" }}>
          <div className="container">
            ...
            >
              Home Page &nbsp;›&nbsp;{" "}
              <strong style={{ color: "#4a5856" }}>Warranty Claim</strong>
            </p>
          </div>
        </section>
          ...
          <div className="container position-relative">
            <div className="row align-items-center">
              <div className="col-lg-6">
                ...
                <p style={s.heroSub}>
                  All Miltronix products come with a manufacturer warranty.
                  Raise your claim online in minutes — no service centre visit
                  needed.
                </p>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "10px" }}>
                  {[
                    "1-Year Standard Warranty",
                    "3-Year on Premium Products",
                    "Doorstep Pickup",
                    "24hr Response",
                  ].map((tag) => (
                    <div
                  ...
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 14px 40px rgba(97,109,107,0.14)";
                    }}
                    onMouseLeave={(e) => {
          ...
          <div className="container">
            ...
            >
              <div>
                ...
                >
                  MiltronixCare — Extended Warranty
                </div>
                <div
                  style={{ fontSize: "13px", color: "rgba(255,255,255,0.65)" }}
                >
                  Get up to 3 years of coverage including accidental damage
                  protection.
                </div>
              </div>
              <button
            ...
            <div className="row g-5 align-items-start">
              <div className="col-lg-4">
                <div style={{ position: "sticky", top: "120px" }}>
                  ...
                  >
                    Fill in the form with your product details, pickup address,
                    and payment preference. We'll get back to you within 24
                    hours.
                  </p>
                  {[
