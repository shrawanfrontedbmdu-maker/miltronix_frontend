...
/* ── Injected styles ── */
const styles = `
  @import url('https://fonts.googleapis.com/css2?family=Arapey:ital@0;1&family=Bricolage+Grotesque:opsz,wght@12..96,200..800&display=swap');
  ...
  .auth-modal .btn-google {
    ...
    padding: 10px;
    background: #fff;
    border: 1px solid rgb(152 146 146) !important;
    border-radius: 8px !important;
    font-family: 'Bricolage Grotesque', sans-serif;
    font-size: 14px;
    font-weight: 300;
  ...
  .auth-modal .btn-google:hover {
    border-color: #616D6B !important;
    box-shadow: 0 2px 8px rgba(97,109,107,0.12);
  }
  ...
  .auth-modal .forgot-link:hover { color: #4A5753; }
  ...
  .auth-modal .profile-list-item:hover {
    background: #d0d0cf;
    color: #616D6B;
  }
    ...
    <>
      ...
      >
        <Modal.Body>
          ...
          <p className="auth-subtitle">
            Join now &amp; unlock exclusive deals and offers!
          </p>
          ...
          {!otpSent ? (
            ...
            <>
              <h2 className="auth-title" style={{ fontSize: 28 }}>
                OTP Verification
              </h2>
              <p className="auth-subtitle">
                Code sent to +91 {signupData.mobile}
              </p>
      ...
      >
        <Modal.Body>
          ...
          <form onSubmit={handleLoginSubmit}>
            ...
            <p className="forgot-link" onClick={switchToForgotPassword}>
              Forgot Password?
            </p>
        ...
        <Modal.Body>
          {!forgotOtpSent ? (
            <>
              ...
              <p className="auth-subtitle">
                We'll send OTP reset instructions to your mobile
              </p>
              <hr className="auth-section-divider" />
            ...
            <>
              ...
              <p className="auth-subtitle">
                Enter the OTP sent to your mobile and choose a new password
              </p>
              <hr className="auth-section-divider" />
      ...
      >
        <Modal.Body style={{ textAlign: "center" }}>
          ...
          <button className="btn-primary-dark" onClick={switchToLogin}>
            Login Now
          </button>
        </Modal.Body>
      </Modal>
      ...
      >
        <Modal.Body>
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            ...
            <p style={{ color: "#737171", fontSize: 13 }}>
          ...
          <div className="profile-list">
            {["Edit Profile", "My Orders", "Saved Addresses", "Settings"].map(
              (item) => (
